...
class AnalystAgent:
    ...
    async def run(self, raw_grants: List[Dict], company_profile: str = "", force: bool = False) -> List[Dict]:
        """Score a batch of raw grants.

        Args:
            raw_grants: List of raw grant documents from MongoDB.
            company_profile: Optional company profile text for scoring context.
